    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="" href="{{route('postsTable')}}" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">All Posts </span><span class=" float-right mr-5 badge badge-pill badge-cyan">{{  $count }}</span></a>
                </li>
                <li> <a class="" href="javascript:void(0)" aria-expanded="false"><i class="ti-files"></i><span class="hide-menu"> Categorys</span></a>
                </li>
                <li> <a class="" href="javascript:void(0)" aria-expanded="false"><i class="ti-user"></i><span class="hide-menu"> All Users</span></a>
                </li>
